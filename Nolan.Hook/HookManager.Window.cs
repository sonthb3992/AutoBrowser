...
namespace Nolan.Hook
{
    public static partial class HookManager
    {
        ...
        #region Window.h header

        //Taken from winuser.h header
        ...
        ///A window receives a client area mouse message when a mouse event occurs within the window's client area. 
        ...
        /// because DefWindowProc propagates it up the parent chain until it finds a window that processes it.
        ...
        /// </summary>
        /// <param name="name">The name of the loaded module (either a .dll or .exe file). 
        /// If the file name extension is omitted, the default library extension .dll is appended. 
        /// The file name string can include a trailing point character (.) to indicate that 
